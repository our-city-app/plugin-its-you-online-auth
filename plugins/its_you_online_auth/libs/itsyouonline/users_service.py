...
class UsersService:
    ...
    def GetAvatarImage(self, hash, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/avatar/img/"+quote(hash)
    ...
    def DeleteUserAddress(self, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/addresses/"+quote(label)
    ...
    def GetUserAddresses(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/addresses"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def DeleteAPIkey(self, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/apikeys/"+quote(label)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def ListAPIKeys(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/apikeys"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def DeleteAuthorization(self, grantedTo, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/authorizations/"+quote(grantedTo)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetAllAuthorizations(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/authorizations"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def CreateAvatarFromImage(self, data, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/avatar/img/"+quote(label)
        return self.client.post(uri, data, headers, query_params, content_type)
    ...
    def UpdateAvatarFile(self, data, newlabel, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/avatar/"+quote(label)+"/to/"+quote(newlabel)
        return self.client.put(uri, data, headers, query_params, content_type)
    ...
    def DeleteAvatar(self, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/avatar/"+quote(label)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetAvatars(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/avatar"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def DeleteUserBankAccount(self, username, label, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/banks/"+quote(label)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetUserBankAccounts(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/banks"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def GetUserContracts(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/contracts"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def DeleteDigitalAssetAddress(self, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/digitalwallet/"+quote(label)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetDigitalWallet(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/digitalwallet"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def ValidateEmailAddress(self, data, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/emailaddresses/"+quote(label)+"/validate"
        return self.client.post(uri, data, headers, query_params, content_type)
    ...
    def DeleteEmailAddress(self, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/emailaddresses/"+quote(label)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetEmailAddresses(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/emailaddresses"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def DeleteFacebookAccount(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/facebook"
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def DeleteGithubAccount(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/github"
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetUserInformation(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/info"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def GetKeyStoreKey(self, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/keystore/"+quote(label)
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def GetKeyStore(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/keystore"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def UpdateUserName(self, data, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/name"
        return self.client.put(uri, data, headers, query_params, content_type)
    ...
    def GetNotifications(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/notifications"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def LeaveOrganization(self, globalid, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/organizations/"+quote(globalid)+"/leave"
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def RejectMembership(self, globalid, role, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/organizations/"+quote(globalid)+"/roles/"+quote(role)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetUserOrganizations(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/organizations"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def UpdatePassword(self, data, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/password"
        return self.client.put(uri, data, headers, query_params, content_type)
    ...
    def ValidatePhonenumber(self, data, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/phonenumbers/"+quote(label)+"/validate"
        return self.client.post(uri, data, headers, query_params, content_type)
    ...
    def DeleteUserPhonenumber(self, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/phonenumbers/"+quote(label)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetUserPhoneNumbers(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/phonenumbers"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def DeletePublicKey(self, label, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/publickeys/"+quote(label)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def ListPublicKeys(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/publickeys"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def DeleteUserRegistryEntry(self, key, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/registry/"+quote(key)
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def ListUserRegistry(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/registry"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def SignSeeObject(self, data, version, uniqueid, globalid, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/see/"+quote(uniqueid)+"/"+quote(globalid)+"/sign/%s"%version
        return self.client.put(uri, data, headers, query_params, content_type)
    ...
    def GetSeeObject(self, uniqueid, globalid, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/see/"+quote(uniqueid)+"/"+quote(globalid)
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def GetSeeObjects(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/see"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def RemoveTOTP(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/totp"
        return self.client.delete(uri, None, headers, query_params, content_type)
    ...
    def GetTwoFAMethods(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)+"/twofamethods"
        return self.client.get(uri, None, headers, query_params, content_type)
    ...
    def GetUser(self, username, headers=None, query_params=None, content_type="application/json"):
        ...
        """
        uri = self.client.base_url + "/users/"+quote(username.encode('utf-8') if isinstance(username, unicode) else username)
        return self.client.get(uri, None, headers, query_params, content_type)
