...
class User(object):
    ...
    @staticmethod
    def create(addresses, bankaccounts, digitalwallet, emailaddresses, firstname, lastname, phonenumbers, publicKeys,
               username, expire=None, facebook=None, github=None):
        """
