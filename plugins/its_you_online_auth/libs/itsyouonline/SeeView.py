...
class SeeView(object):
    ...
    @staticmethod
    def create(category, content_type, creation_date, end_date, globalid, keystore_label, link,
               markdown_full_description, markdown_short_description, signature, start_date, uniqueid, username,
               version):
        """
        :type category: str
